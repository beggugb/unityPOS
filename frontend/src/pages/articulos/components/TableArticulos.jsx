...
class TableArticulos extends React.Component {  
constructor(props){
    super(props);
    this.state = {      
      nroPagina:12,
...
makeHttpRequestWithPage = (pageNumber,num) => {
    this.props.articuloData(pageNumber,num)
} 
...
handleDelete = () => {            
this.props.articuloDelete(this.state.deleteId);  
   this.setState({
    modalDelete: false,    
    deleteId:0
   })
...
toggleModal = (item) => {   
  ...
  this.props.articuloItem(est,item)
}
...
toggleView = (item) => {   
  ...
  this.props.articuloView(est,item)
}
render() {    
            ...
            <td className="text-center">
              <ButtonGroup>              
                ...
                <Button                                
                  ...
                  type="button"                                                  
                  onClick={() => this.toggleImagen(item) } >
...
export default connect(mapStateToProps,mapDispatchToProps)(TableArticulos);